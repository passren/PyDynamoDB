...
class TestDmlSelect:
    ...
    def test_parse_simple_case_2(self):
        ...
        """
        ret = SQLParser(sql).transform()
        assert(ret == {"Statement": "SELECT * FROM \"Orders\" WHERE OrderID = 100 OR OrderID IN [200,300,234]"})
    ...
    def test_parse_simple_case_3(self):
        ...
        """
        ret = SQLParser(sql).transform()
        assert(ret == {"Statement": "SELECT * FROM \"Orders\" WHERE OrderID = 100 ORDER BY OrderID DESC"})
    ...
    def test_parse_simple_case_4(self):
        ...
        """
        ret = SQLParser(sql).transform()
        assert(ret == {"Statement": "SELECT * FROM \"Orders\" WHERE OrderID = ? AND Title = ?"})
